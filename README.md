...
![status](https://img.shields.io/badge/status-P2_tee-orange)
...
**Status:** `0.2.0` — P0+P1+P2: core internals, interop helpers, and **`tee`** strategy. `race` / `fallback` / `merge` land in P3–P5. Spec: [`docs/proposal.MD`](./docs/proposal.MD).
...
| `pnpm test`               | Vitest — `LSM-REL-*`, `LSM-TYP-*`, `LSM-CORE-*`, `LSM-TEE-*`, `LSM-EDGE-P0-*`, `LSM-SRC-*` |
