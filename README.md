...
![status](https://img.shields.io/badge/status-P1_core_%2B_interop-yellow)
...
**Status:** `0.1.0` — P0+P1 complete (core internals + interop helpers). Strategies land in P2–P5. Spec: [`docs/proposal.MD`](./docs/proposal.MD).
...
| `pnpm test`               | Vitest — `LSM-REL-*`, `LSM-TYP-*`, `LSM-CORE-*`, `LSM-EDGE-P0-*`, `LSM-SRC-*`           |
